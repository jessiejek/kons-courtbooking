  ...
  return (
    <div className="max-w-3xl mx-auto py-8 animate-fade-in pb-32">
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <footer className="fixed bottom-14 lg:bottom-0 left-0 lg:left-64 right-0 bg-white/90 backdrop-blur-md border-t border-outline-variant px-4 lg:px-10 py-4 z-40">
